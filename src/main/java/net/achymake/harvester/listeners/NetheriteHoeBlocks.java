...
public class NetheriteHoeBlocks implements Listener {
    private Hoe getHoe() {
    ...
    public NetheriteHoeBlocks(Harvester plugin) {
        plugin.getServer().getPluginManager().registerEvents(this, plugin);
    }
    @EventHandler(priority = EventPriority.HIGHEST)
    public void onNetheriteHoeBlocks(PlayerInteractEvent event) {
